    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                switch (respCode){
                    case 400: Log.e(LOG_TAG,"Bad Request"); break;
                    case 401: Log.e(LOG_TAG,"Unauthorized"); break;
                    case 403: Log.e(LOG_TAG,"Forbidden"); break;
                    case 404: Log.e(LOG_TAG,"Not Found"); break;
                    case 500: Log.e(LOG_TAG,"Internal Server Error"); break;
                    case 502: Log.e(LOG_TAG,"Bad Gateway"); break;
                    default: Log.e(LOG_TAG, "Error response code: " + urlConnection.getResponseCode());break;
                }
